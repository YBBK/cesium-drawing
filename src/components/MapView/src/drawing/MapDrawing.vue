<template>
    <div class="map-drawing" v-if="drawer">
        <ButtonGroup>
            <ColorPickButton icon="point" :isActive="currentType == GraphicType.Point" @click="drawPoint" />
            <ColorPickButton icon="line" :isActive="currentType == GraphicType.PolyLine" @click="drawLine" />
            <ColorPickButton icon="polygon" :isActive="currentType == GraphicType.Polygon" @click="drawPolygon" />
            <ColorPickButton icon="circle" :isActive="currentType == GraphicType.Circle" @click="drawCircle" />
            <ColorPickButton icon="rect" :isActive="currentType == GraphicType.Rectangle" @click="drawRect" />
        </ButtonGroup>
        <IconButton icon="edit" @click="toggleEdit()" v-if="!isEditMode" />
        <IconButton icon="check" @click="toggleEdit()" v-else />

        <ElementEdit :data="selectedGraphic" @fly-to="flyTo" @save="save" @remove="deleteGraphicById" @close="() => (selectedGraphic = undefined)" />
    </div>
</template>
...
function getDrawer(): Drawer | null {
    return drawer;
}
